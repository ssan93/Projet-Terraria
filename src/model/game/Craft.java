...
public class Craft {
	...
	public static void inizCraft() {
		objetÀcraft.put("1 bois, 2 metal", new Weapon("couteau", "Le couteau Bowie, parfois appelé cure-dent de l'Arkansas (« Arkansas toothpick »), est un genre de couteau dont la popularité vient de son usage intensif faite par le colonel James Bowie, qui en créa la légende et le démocratisa. ",5));
